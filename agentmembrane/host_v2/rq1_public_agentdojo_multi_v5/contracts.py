"""Source-locked contracts for the RQ1 AgentDojo v5 stress selector.
...
SELECTOR_ID = "rq1-public-agentdojo-multi-v5-tool-knowledge"
...
def contracts_manifest() -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "artifact_type": "agentmembrane_rq1_agentdojo_multi_contracts_v5",
