"""Read-only live web monitor for durable RQ1 v4 run namespaces."""
...
<title>RQ1 v4 Live Monitor</title>
<style>
...
<div class="top"><div><h1>RQ1 v4 · Tool-Knowledge Stress</h1><div class="sub" id="namespace">loading…</div></div><div><span class="pulse"></span><span id="clock">connecting</span></div></div>
<div class="grid">
...
def serve(run_dir: Path, *, host: str, port: int) -> None:
    ...
    print(f"RQ1 v4 monitor: http://{host}:{port}/", flush=True)
