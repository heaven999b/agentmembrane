"""Version-isolated AgentDojo adapter with the frozen v4 attack baseline."""
...
class ToolKnowledgeAgentDojoAdapter(AgentDojoAdapter):
    ...
    adapter_id = "agentdojo-v0.1.35-rq1-tool-knowledge-baseline-v4"
    ...
    def reset(self, source_task_id: str) -> Mapping[str, Any]:
        ...
        if len(vector_ids) != 1:
            raise RuntimeError("v4 adversarial row must bind exactly one carrier")
