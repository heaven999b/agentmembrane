"""Durable 48-cell executor for the RQ1 v4 tool-knowledge baseline.
...
SCHEMA_VERSION = 1
PROFILE_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_real_profile_v4"
AUTHORIZATION_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_real_authorization_v4"
CONSUMPTION_ARTIFACT_TYPE = (
    "agentmembrane_rq1_multi_source_authorization_consumption_v4"
)
CELL_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_cell_v4"
REPORT_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_report_v4"
CALL_RESERVATION_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_call_reservation_v4"
CALL_TERMINAL_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_call_terminal_v4"
CELL_COUNT = 48
MAX_TURNS_PER_CELL = 6
GLOBAL_CALL_CAP = 288
CANARY_CELL_COUNT = 2
CANARY_CALL_CAP = 12
CONTINUATION_CELL_COUNT = 46
CONTINUATION_CALL_CAP = 276
CANARY_ORDINALS = (3, 4)
...
_CODE_RELATIVE_PATHS = {
    ...
    "analysis": Path("agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/analysis.py"),
    "attack_attribution": Path(
        "agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/attribution.py"
    ),
    ...
    "executor": Path("agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/executor.py"),
    "gate": Path("agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/gate.py"),
    "provider_agent": Path(
    ...
    "runtime": Path("agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/runtime.py"),
    "runtime_receipt": Path(
        "agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/runtime_receipt.py"
    ),
    "selector": Path("agentmembrane/host_v2/rq1_public_agentdojo_multi_v4/selector.py"),
}
...
def _adapter_preflight_under_pinned_python(root: Path) -> dict[str, Any]:
    ...
    script = (
        ...
        "from agentmembrane.host_v2.rq1_public_agentdojo_multi_v4.adapter "
...
def _runtime_binding(
    ...
    try:
        ...
        import_preflight = validate_v4_runtime_receipt(
...
def _continuation_cells() -> tuple[EngineeringCell, ...]:
    ...
    if len(cells) != CONTINUATION_CELL_COUNT:
        raise MultiSourceExecutorError("continuation schedule must contain 46 cells")
    return cells
...
def build_profile_document(
    ...
    *,
    ...
    profile = {
        ...
        "profile_id": "rq1-agentdojo-tool-knowledge-stress-v4",
...
def build_authorization_document(
    *, profile: Mapping[str, Any], namespace: str
    ...
    return {
        ...
        "authorization_id": f"{namespace}-authorization-v4",
        "decision": "AUTHORIZE_EXACT_48_CELL_TOOL_KNOWLEDGE_STRESS_RUN",
...
def _canary_report(
    ...
    return {
        "schema_version": SCHEMA_VERSION,
        "artifact_type": "agentmembrane_rq1_multi_source_canary_report_v4",
...
def execute_canary_test_only_v4(
    *,
    repo_root: Path,
    output_root: Path,
    namespace: str,
...
def resume_canary_test_only_v4(
    *,
    repo_root: Path,
    namespace_path: Path,
    gate_receipt: Mapping[str, Any] | Path | str,
...
def execute_continuation_test_only_v4(
    *,
    repo_root: Path,
    namespace_path: Path,
    gate_receipt: Mapping[str, Any] | Path | str,
...
__all__ = [
    ...
    "execute_continuation_v4",
    "execute_continuation_test_only_v4",
    "resume_canary_v4",
    "resume_canary_test_only_v4",
]
