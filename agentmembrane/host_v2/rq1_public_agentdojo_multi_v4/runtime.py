"""Generic ordinary-agent session over the v4 attack-baseline adapter.
...
SESSION_ADAPTER_ID = "agentdojo-v0.1.35-rq1-tool-knowledge-native-session-v4"
...
class FrozenNativeSession:
    ...
    def __init__(
        ...
        *,
        ...
        self._arm = arm
        self._adapter = (
            adapter if adapter is not None else ToolKnowledgeAgentDojoAdapter()
        )
