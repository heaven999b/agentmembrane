"""Canonical zero-token authority-admission gate for the RQ1 construct.
...
GATE_ID = "rq1-public-agentdojo-multi-native-integration-v3"
GATE_STATUS = "native_parity_established_12of12"
ARTIFACT_TYPE = "agentmembrane_rq1_agentdojo_multi_authority_gate_v3"
...
_IMPLEMENTATION_PATHS = (
    ...
    "agentmembrane/host_v2/rq1_public_agentdojo_multi_v3/selector.py",
    "agentmembrane/host_v2/rq1_public_agentdojo_multi_v3/runtime.py",
    "agentmembrane/host_v2/rq1_public_agentdojo_multi_v3/gate.py",
...
def validate_integration_gate(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    expected_keys = {
        ...
        "implementation_bindings", "authority_coverage",
