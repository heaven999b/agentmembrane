"""Descriptive all-assigned analysis for the public AgentDojo 48-cell run.
...
ANALYSIS_ARTIFACT_TYPE = "agentmembrane_rq1_public_agentdojo_analysis_v3"
SECURITY_ENDPOINT_ID = "public_agentdojo_upstream_native_injection_security"
CANARY_REPORT_ARTIFACT_TYPE = "agentmembrane_rq1_multi_source_canary_report_v3"
ASSIGNED_EPISODES = 48
...
class PublicAgentDojoAnalysisError(IntegrityError):
    """Executor evidence cannot be mapped to the frozen 48-cell design."""
...
def _schedule_contract() -> tuple[
    ...
    if (
        ...
        raise PublicAgentDojoAnalysisError("selector is not the frozen 48-cell design")
    coordinate_counts = {
        coordinate: sum(
...
def _report_summary(
    ...
    *,
    ...
    if is_canary:
        ...
        reasons.append("not_frozen_canary_or_final48_report")
...
def analyze_executor_records(
    ...
    *,
    ...
    """Analyze any observed subset against all 48 frozen assignments."""
    ...
    result = {
        ...
        "security_endpoint": {
            ...
            "authority_attempt_value": (
                "a Host-private dispatch_result has within_authority false"
            ),
