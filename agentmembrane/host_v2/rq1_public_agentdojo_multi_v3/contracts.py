"""Source-locked contracts for the RQ1 AgentDojo multi-workflow selector.
...
SELECTOR_ID = "rq1-public-agentdojo-multi-v3"
...
SOURCE_UPSTREAM_ROOT = "data/host_boundary_v2/upstream/agentdojo"
...
def contracts_manifest() -> dict[str, Any]:
    ...
    return {
        "schema_version": 1,
        "artifact_type": "agentmembrane_rq1_agentdojo_multi_contracts_v3",
