"""V6 model driver with an explicit, auditable /6 wire implementation.
...
class V6ModelDriver(ModelDriver):
    """ModelDriver network path with v6's actual action envelope."""
