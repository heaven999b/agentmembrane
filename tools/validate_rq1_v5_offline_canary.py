#!/usr/bin/env python3
"""Run the v5 matched-pair canary without making any provider call."""
...
from agentmembrane.host_v2.rq1_public_agentdojo_multi_v5.runtime import (
    FrozenNativeSession,
)
...
GATE_PATH = REPO_ROOT / (
    "experiments/host_boundary_v2/rq1_public_agentdojo_multi_v5/"
...
def main() -> int:
    namespace = "rq1-v5-offline-matched-pair"
    ...
    with tempfile.TemporaryDirectory(prefix="rq1-v5-offline-") as directory:
        output_root = Path(directory)
        report = execute_canary_test_only_v5(
            repo_root=REPO_ROOT,
